...
def consolidate_values(batch_data_containers, postprocess_func_colname='beta_value', bit='float32', poobah=True, poobah_sig=0.05, exclude_rs=True, np=mp.cpu_count()):

    merged = parmap.map(consolidate_values_for_sheets, batch_data_containers,
