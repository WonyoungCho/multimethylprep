...
def run_pipeline(data_dir, array_type=None, export=False, manifest_filepath=None,
                 ...
                 sesame=True, quality_mask=None, np=1,
                 pneg_ecdf=False, file_format='pickle', **kwargs):
    ...
    if meta_data_frame == True:
        ...
        if file_format == 'parquet':
            meta_frame_filename = f'sample_sheet_meta_data.par'
    ...
    if save_control:
        if file_format == 'parquet':
            control_filename = f'control_probes.par'
